...
contract TimelockTransferUnitFuzzTest is BaseTest {
    ...
    function test_GivenTimelockPeriodNotPassed(uint40 timeskip) external givenLockToTransferIsFrozen {
        timeskip = uint40(bound(timeskip, 0, timelock - 1));
        skip(timeskip);
